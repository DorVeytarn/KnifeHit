...
namespace UnitySpriteCutter {
	...
	public class SpriteCutterInput {
		...
		public CutterMode gameObjectCreationMode;

		public SpriteCutterInput(GameObject gameObject, Vector2 lineStart, Vector2 lineEnd, CutterMode gameObjectCreationMode = 0, bool dontCutColliders = false)
        {
			this.gameObject = gameObject;
			this.lineStart = lineStart;
			this.lineEnd = lineEnd;
			this.gameObjectCreationMode = gameObjectCreationMode;
			this.dontCutColliders = dontCutColliders;
		}
	...
	public static class SpriteCutter {
		...
		public static SpriteCutterOutput Cut( SpriteCutterInput input ) {
			...
			if ( input.gameObjectCreationMode == CutterMode.CUT_INTO_TWO ) {
			...
			} else if ( input.gameObjectCreationMode == CutterMode.CUT_OFF_ONE ) {
